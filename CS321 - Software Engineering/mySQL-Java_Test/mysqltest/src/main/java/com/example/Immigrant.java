...
public class Immigrant extends Person {
    ...
    /***
     * Constructs a blank immigrant
     * @param anum
     */
    private Immigrant(String anum){
        super();
        this.a_Number = anum;
    }
    ...
    public static Immigrant addImmigrant(String aNum, String fname, String lname, int personId, Date DOB, boolean isDep){
        ...
        Immigrant newImm = new Immigrant(aNum, fname, lname, personId, DOB, isDep);
        return newImm;
    }
     ...
     */
    public String getA_NumberString() {return a_Number;}
