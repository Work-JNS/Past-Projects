...
// Supported Features
#define FEATURE_SUSPEND 1 // Does StrawHat Support Suspend and Resume of Processes? (0 - no, 1 - yes)
#define FEATURE_REAP 0    // Does StrawHat Support Reaping Defunct Processes? (0 - no, 1 - yes)
#define FEATURE_MLFQ 0    // Does StrawHat Support MLFQ Operations (promotions) (0 - no, 1 - yes)
