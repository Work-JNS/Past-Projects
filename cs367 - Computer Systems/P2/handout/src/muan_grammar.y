...
expression:  NUMBER           { $$ = $1; }
  ...
  | DISPLAY_T '(' VARIABLE ')'  { MSG("display(X)");
                                $$ = get_value($3);
                                ECHOTTY("\n");
                                sym_exists($3)?print_value("MicroFP Value in Binary", $$):print_sym_not_found($3);
                              }
  | DISPLAY_T '(' expression ')'  { MSG("display(exp)");
                                $$ = $3;
                                ECHOTTY("\n");
                                print_value("MicroFP Value in Binary", $$);
                              }
  | SYNERR_T                  { MSG("ERROR");
