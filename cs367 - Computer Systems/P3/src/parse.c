...
static char *instructs_list_full[] = {"quit", "help", "list", "delete", "start_fg", "start_bg", "kill", "suspend", "resume_fg", "resume_bg", "fg", "pipe", "chain", NULL};

// instructions which may use an Task Number argument
static char *instructs_with_num[] = {"delete", "start_fg", "start_bg", "kill", "suspend", "resume_fg", "resume_bg", "fg", "pipe", "chain", NULL};

// instructions which may use a 2nd Task Number argument
static char *instructs_with_num2[] = {"pipe", "chain", NULL};

// instructions which may use filename arguments
static char *instructs_with_file[] = {"start_fg", "start_bg", NULL};
